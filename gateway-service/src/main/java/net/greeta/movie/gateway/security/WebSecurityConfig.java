    ...
    public SecurityWebFilterChain securityFilterChain(ServerHttpSecurity http) {
        return http
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers("/employee", "/employee/**").hasRole(MOVIE_MANAGER)
                        .pathMatchers(HttpMethod.GET, "/bank", "/bank/**").permitAll()
                        .pathMatchers("/bank/*/comments").hasAnyRole(MOVIE_MANAGER, MOVIE_USER)
                        .pathMatchers("/bank", "/bank/**").hasRole(MOVIE_MANAGER)
                        .pathMatchers("/bank/userextras/me").hasAnyRole(MOVIE_MANAGER, MOVIE_USER)
